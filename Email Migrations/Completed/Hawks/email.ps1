...
$company_name       = "Hawks Agro"
$company_ou         = "OU=$company_name,OU=Customers,DC=internal,DC=ksphosting,DC=com"

$tenant_name        = "hawksagrosk.onmicrosoft.com"
$company_domain     = "hawksagro.com"
...
if($CREATE_MAPPING_CSV)
{
    ...
    if($addresses.length -ne $sams.length)
    {
        ...
        # NOTE (evan): This check is honestly not worth it. If there are any users in the No AD Sync OU, this check will fail
    }
    else
    {
