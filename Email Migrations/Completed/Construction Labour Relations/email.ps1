...
if($INCREASE_MAX_SEND_RCV) {
    ...
    #!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
    # TODOO(dallas): What's the point of this information? !
    #!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
...
{
    $onmicrosoft_csv_name = "onmicrosoft_Distro_addressess.csv"
    ...
    #!!!!!
    #!!!!!
    $mailboxes = (Get-O365distributiongroup -Filter { -not (DisplayName -like "Discovery Search Mailbox") } | sort Alias) 
    #!!!!!
...
if($CREATE_MAPPING_CSV)
{
    ...
    $samaccountname_csv_name = "sam_distro_names.csv"
    $samaccountname_csv_path = "."
    $samaccountname_csv_fullpath = "${samaccountname_csv_path}\${samaccountname_csv_name}"

    $sams = (Get-HostedDistributionGroup -OrganizationalUnit $company_ou | sort samaccountname | select -ExpandProperty samaccountname)
...
#================================================================================================================================================#
$EXPORT_ALIASES_AND_ATTRIBUTES=$false
...
if($EXPORT_ALIASES_AND_ATTRIBUTES)
{
    ...
    ######Run this section BEFORE deleting exchange objects verify that exported csvs contain valid data########################################### Section 1#############
    # $csv = "C:\scripts\o365\TargetAddressImports\targetaddscsa.csv"
