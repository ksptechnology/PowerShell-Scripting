...
$company_name       = "Boyd Excavating"
$company_ou         = "OU=$company_name,OU=Boyd_Bowline,OU=Customers,DC=internal,DC=ksphosting,DC=com"

$tenant_name        = "boydbowline.onmicrosoft.com"
$company_domain     = "boydexcavating.ca"
