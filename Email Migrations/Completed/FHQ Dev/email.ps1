...
$company_name       = "FHQ Developments"
$company_ou         = "OU=$company_name,OU=$company_name,OU=Customers,DC=internal,DC=ksphosting,DC=com"
#^ Double Company OU because of FHQ's weird setup

$tenant_name        = "fhqdevsk.onmicrosoft.com"
$company_domain     = "fhqdev.com"
